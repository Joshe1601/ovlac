...
if (! function_exists('relative_path')) {
    ...
    function relative_path()
    {
        ...
        $base_path_pattern = $env["BASE_PATH_PATTERN"];

        $url = str_replace("file:///","", base_path());
        $url = str_replace("\\","/", $url);
        $url = str_replace($_SERVER['DOCUMENT_ROOT'],"", $url);

        /*SYG 20240226:
         * Lineas extra para limpiar $url y dejar solo el path relativo a la carpeta de instalacion del configurador.
         * Ejemplo: $url = "/config3d";
         * ATENCION: Es importante que el path relativo empiece por "/"
         */
        $url = str_replace($base_path_pattern,"", $url);
        return $url;
    }
}
