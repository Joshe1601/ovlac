                ...
                >
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            @if ($product->image)
                                <img src="{{ relative_path() }}{{ $product->image }}" alt="product img" class="rounded-xl m-2" style="max-width: 200px;">
                ...
                <div class="container d-flex flex-wrap justify-content-center">
                    ...
                    <div class="text-end">
                        <a
                            href="#"
                            type="button"
                            class="btn btn-success rounded rounded-xl bg-red-ovlac text-white px-6 py-3"
                            aria-current="true"
