        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <div>
                    ...
                    @else
                    <input type="checkbox" name="subparts[{{ $product_part->id }}][optional]" id="optional" @if ($product_part->optional) checked @endif>
                    <label for=optional>{{ tra("Accessory Part") }}</label>
                    @endif
                </div>
            </div>
        </div>
