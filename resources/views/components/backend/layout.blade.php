...
{{-- <script src = "https://cdnjs.cloudflare.com/ajax/libs/bootstrap-colorpicker/3.4.0/js/bootstrap-colorpicker.js" > </script>
...
<header>
    ...
    <div class="container">
        ...
        <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
                <a
                    href="{{ controller_path() }}{{ controller_sep() }}module=product&action=index"
                    type="button"
    ...
    <div class="container d-flex flex-wrap justify-content-center">
        ...
        <div class="text-end">
            <a href="{{ controller_path() }}{{ controller_sep() }}module=product&action=create" type="button" class="btn btn-success">{{ tra("New Product") }}</a>
        </div>
        @if (isset($product))
